...
6. Create a repository at your github account website to get a link

7. Add Origin in source code folder with .git folder
$ git remote add origin https://github.com/<github account>/<your repository name>.git
